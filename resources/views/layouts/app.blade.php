    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div class="sidebar w-64 text-white p-6">
            ...
            <nav class="sidebar-nav space-y-1">
                ...
                <a href="{{ route('tasks.index') }}" class="nav-link {{ Route::is('tasks.*') ? 'active' : '' }}">
                    <i class="nav-icon fas fa-tasks"></i>
                    Tasks
                </a>
                <a href="{{ route('comments.index') }}" class="nav-link {{ Route::is('comments.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('system-parameters.index') }}" class="nav-link {{ Route::is('system-parameters.*') ? 'active' : '' }}">
        ...
        <div class="main-content flex-1">
            <!-- Top Bar -->
            <div class="top-bar">
                <h2 class="page-title">@yield('page-title', 'Welcome')</h2>
                <div class="user-menu">
                    @auth
                        <div class="user-info">
                            <p class="user-name">{{ Auth::user()?->Name ?? 'User' }}</p>
                            <p style="font-size: 0.75rem; color: #718096;">{{ Auth::user()->Role }}</p>
                        </div>
                        <div class="user-badge">{{ substr(Auth::user()->Name, 0, 1) }}</div>
