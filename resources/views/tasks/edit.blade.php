                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($departments as $dept)
                            <option value="{{ $dept->DepartmentID }}" {{ old('DepartmentID', $task->DepartmentID) == $dept->DepartmentID ? 'selected' : '' }}>
                                {{ $dept->DepartmentName }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($users as $user)
                            <option value="{{ $user->UserID }}" {{ old('AssignedTo', $task->AssignedTo) == $user->UserID ? 'selected' : '' }}>
                                {{ $user->Name }}
                            </option>
                        @endforeach
                    </select>
