<?php $__env->startSection('title', 'Create Report - Task Management System'); ?>
<?php $__env->startSection('page-title', 'Create New Report'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-lg shadow-md p-8">
        <h3 class="text-2xl font-bold text-gray-800 mb-6">Create New Report</h3>
                    ...
                    <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="mb-3 flex items-start">
                            <input 
                                ...
                                class="mt-1 rounded"
                                <?php echo e((is_array(old('task_ids')) && in_array($task->TaskID, old('task_ids'))) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\task_management_system\resources\views/reports/create.blade.php ENDPATH**/ ?>