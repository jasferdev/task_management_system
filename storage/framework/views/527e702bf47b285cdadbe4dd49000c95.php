<?php $__env->startSection('title', 'Edit System Parameter - Task Management System'); ?>
<?php $__env->startSection('page-title', 'Edit System Parameter'); ?>
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow-md p-8">
        ...
        <form action="<?php echo e(route('system-parameters.update', $parameter)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    value="<?php echo e(old('ParameterType', $parameter->ParameterType)); ?>"
                    disabled
                >
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    required
                ><?php echo e(old('ParameterValue', $parameter->ParameterValue)); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\task_management_system\resources\views/system-parameters/edit.blade.php ENDPATH**/ ?>